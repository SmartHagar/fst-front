...
const Footer = () => {
  return (
    <footer
      className="text-black body-font font-cabin mt-4"
      style={styles.footer}
    >
      <div className="container px-2 py-2 mx-auto flex items-center sm:flex-row flex-col">
        <a
          ...
          href="/"
        >
          <span className="ml-3 text-lg">Fakultas Sains & Teknologi</span>
        </a>
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          <a className="ml-3 text-pink-700" href="/">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
          ...
          <a className="ml-3 text-blue-900" href="/">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <a className="ml-3 text-red-900" href="/">
            <svg
              fill="currentColor"
              stroke="currentColor"
              strokeLinecap="round"
